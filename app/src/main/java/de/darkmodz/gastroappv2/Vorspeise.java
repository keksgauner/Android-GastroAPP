...
public class Vorspeise extends AppCompatActivity {

    /**
     * Globalvariablen
     */
    private Vorspeise context;
    private TableLayout tableLayout;

    /**
     * Methoden
     */
    public Vorspeise getContext() {
        return context;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vorspeise);
        setTitle("Vorspeise");

        /**
         * Nutzerelemente hinzufügen
         */
        tableLayout = (TableLayout) findViewById(R.id.tableInvoices);
         ...
         */
        Button buttonZurueckVorspeise = (Button) findViewById(R.id.buttonZurueckVorspeise);
