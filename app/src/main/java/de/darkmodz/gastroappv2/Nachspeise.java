...
public class Nachspeise extends AppCompatActivity {

    /**
     * Globalvariablen
     */
    private Nachspeise context;
    private TableLayout tableLayout;

    /**
     * Methoden
     */
    public Nachspeise getContext() {
        return context;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nachspeise);
        setTitle("Nachspeise");

        /**
         * Nutzerelemente hinzufügen
         */
        tableLayout = (TableLayout) findViewById(R.id.nachspeiseTableInvoices);
         ...
         */
        Button buttonZurueckVorspeise = (Button) findViewById(R.id.buttonZurueckNachspeise);
