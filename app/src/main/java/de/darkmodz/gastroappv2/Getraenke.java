...
public class Getraenke extends AppCompatActivity {
     ...
     * Globalvariablen
     */
    private Getraenke context;
    private TableLayout tableLayout;

    /**
     * Methoden
     */
    public Getraenke getContext() {
        return context;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        tableLayout = (TableLayout) findViewById(R.id.getraenkeTableInvoices);
         ...
         */
        Button buttonZurueckVorspeise = (Button) findViewById(R.id.buttonZurueckGetraenke);
